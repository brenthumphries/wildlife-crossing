...
- [[2026-07-28-next-build]] — First build; the first binaries in project history exist. **Its B1 headline ("the pck ships zero game data") was later disproved** — see [[../daily-logs/2026-07-28]]; the pack was always complete and boots clean. **B2, B3, B5, and B6 have since closed** (2026-07-28/29 logs) — a macOS `.app` has been launched and confirmed playable, and the overpass now follows ADR 0016's span geometry instead of paving whole segments. Only **B4** (placement UI, unblocked now that B3 is done) remains
